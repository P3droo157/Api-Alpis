...
domain = 'apis-sla.onrender.com'// domain website tanpa http or https
...
loghandler = {
    ...
    instgram: {
	    status: false,
	    code: 403,
	    message: '[!] Proibido ou Erro, Nome de usuário não wujud ou conta privada',
	    maintanied_by: `${creator}`
   },
    register: {
	    status: false,
